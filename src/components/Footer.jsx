...
const Footer = () => {
  return (
    <footer className="footer flex flex-col md:flex-row md:center justify-between items-center p-4 bg-neutral text-neutral-content">
    ...
    <div className="flex flex-row md:justify-end mt-4 md:mt-0 gap-3">
